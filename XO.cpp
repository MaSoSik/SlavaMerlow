...
void rule() {
	...
	cout << "Игроки по очереди вводят на свободные клетки поля знаки(один всегда крестики, другой всегда нолики).\n";
	cout << "Игрок кто первым выстроит в ряд из своих фигур по вертикали, горизонтали или диагонали линию, выигрывает.\n";
	cout << "Для всех типов полей (3х3, 4х4, 5х5) правила одинаковые. Меняется только размер клеток";
